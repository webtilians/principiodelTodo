...
FROZEN_CASE_COMMIT = "6761557ab7404ba02472bf1c86963de7d0429ece"
FROZEN_SUITE_SHA256 = "8a0a4600d9545e63ffa5da77006ed324c0a98c50c41d41d57ed11f529ecfd222"
IMPLEMENTATION_COMMIT = "3309095c2e0df436ce1772ecbf77601189c50fe8"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run frozen INFINITO 3.0 long-horizon held-out V5.")
    ...
    parser.add_argument("--output-dir", default="trajectory-holdout-v5-results")
...
def main() -> int:
    ...
    case_path = REPO_ROOT / "src" / "infinito3" / "trajectory_holdout_v5_cases.py"
    actual_suite_hash = hashlib.sha256(case_path.read_bytes()).hexdigest()
    if actual_suite_hash != FROZEN_SUITE_SHA256:
        raise SystemExit(f"Frozen V5 suite changed: {actual_suite_hash}")
    ...
    report = TrajectoryEvaluationHarness(loop_pair_factory).run(independent_trajectory_holdout_v5_suite())
    ...
    report.metadata.update({
        ...
        "context_builder": "preference_state_context_v1_with_history_evidence_resolution",
    ...
    json_path = output_dir / "infinito3-trajectory-holdout-v5.json"
    md_path = output_dir / "infinito3-trajectory-holdout-v5.md"
    json_path.write_text(report.to_json(), encoding="utf-8")
    md_path.write_text(report.to_markdown(), encoding="utf-8")

    print("INFINITO 3.0 FIFTH FROZEN LONG-HORIZON HELD-OUT")
