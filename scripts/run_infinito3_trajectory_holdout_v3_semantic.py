...
IMPLEMENTATION_BASELINE_COMMIT = "9256992d2ac997bde2ab6a5851f29a9211e9eed7"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run frozen V3 with semantic cognitive event extraction.")
    ...
    parser.add_argument("--output-dir", default="trajectory-holdout-v3-semantic-results")
...
def main() -> int:
    ...
    json_path = output_dir / "infinito3-trajectory-holdout-v3-semantic.json"
    md_path = output_dir / "infinito3-trajectory-holdout-v3-semantic.md"
    json_path.write_text(report.to_json(), encoding="utf-8")
    md_path.write_text(report.to_markdown(), encoding="utf-8")

    print("INFINITO 3.0 FROZEN V3 + SEMANTIC COGNITIVE EVENT EXTRACTOR")
    print(f"implementation_baseline_commit={IMPLEMENTATION_BASELINE_COMMIT}")
