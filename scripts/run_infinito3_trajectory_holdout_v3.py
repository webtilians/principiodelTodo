...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run frozen INFINITO 3.0 long-horizon held-out v3.")
    ...
    parser.add_argument("--output-dir", default="trajectory-holdout-v3-results")
...
def main() -> int:
    ...
    json_path = output_dir / "infinito3-trajectory-holdout-v3.json"
    md_path = output_dir / "infinito3-trajectory-holdout-v3.md"
    json_path.write_text(report.to_json(), encoding="utf-8")
    md_path.write_text(report.to_markdown(), encoding="utf-8")

    s = report.summary
    print("INFINITO 3.0 THIRD FROZEN LONG-HORIZON HELD-OUT")
