...
🆕 REFACTORIZADO: Ahora usa módulos core/ para mejor mantenibilidad.
"""
...
from core import (
    ...
    LegacyExternalMemory,  # Para compatibilidad temporal
...
# 🆕 MIGRADO A core/memory.py
# La clase EnhancedExternalMemory ahora se importa desde core.memory
# Usar LegacyExternalMemory para compatibilidad o PriorityExternalMemory para la versión mejorada
EnhancedExternalMemory = LegacyExternalMemory  # Alias para compatibilidad

# Clase original comentada - ahora en core/memory.py
# class EnhancedExternalMemory(nn.Module):
#     """🧠 V5.1 Enhanced External Memory with AUTO-ACTIVATION"""
#     ... (código movido a src/core/memory.py)
